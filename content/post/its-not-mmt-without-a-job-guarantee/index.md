...
It started [with a claim from André](https://billmitchell.org/blog/?p=38829#comment-78985), that an MMTer could support other policy agendas instead of the Job Guarantee:

> There are other alternatives and other agendas that a MMTer could support.

[Neil's response](https://billmitchell.org/blog/?p=38829#comment-78989) was typically direct:
...
[Bill then filled in a piece of history](https://billmitchell.org/blog/?p=38829#comment-78997) that gets lost in these arguments — where the term "Job Guarantee" actually came from.
...
[André pushed back against Neil](https://billmitchell.org/blog/?p=38829#comment-78998), arguing MMT is compatible with other routes to full employment and price stability, and that the Job Guarantee is only ever the best option, not the only one.
...
[He then took the argument further](https://billmitchell.org/blog/?p=38829#comment-78999) — that MMT describes how the monetary system works, and says nothing about what should be done with that knowledge.
...
[Bill's reply closed the argument](https://billmitchell.org/blog/?p=38829#comment-79000).
...
André [had the last word](https://billmitchell.org/blog/?p=38829#comment-79001), if not quite the argument:
